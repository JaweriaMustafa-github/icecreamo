      ...
      <div className="relative z-10">
        <div className="max-w-6xl mx-auto text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-4">
            Yummy Icecreamos in our Menu
          </h1>
          <p className="text-xl text-white">
            Delight your taste buds with our irresistible selection of premium
            ice creams—order your favorites now!
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto mt-8">
          <button
            onClick={toggleCart}
            className="border-4 border-purple-800 text-white py-3 px-6 shadow-md rounded-lg hover:bg-purple-800 transition-transform duration-300 scale-105 ease-in-out"
          >
                ...
                <span className="ml-4 text-lg font-semibold text-black">
                 {product.name} - ${product.price}
                  ...
                  <button
                    ...
                    className="bg-purple-800 text-white py-3 px-8 rounded-lg shadow-md text-lg hover:bg-purple-500 transition duration-300 ease-in-out transform hover:scale-110"
                  >
                    Proceed to Checkout
                  </button>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg w-full sm:w-96">
            ...
            <div className="mt-6 flex justify-between">
              <button
                ...
                className="bg-purple-800 text-white py-2 px-6 rounded-lg text-lg shadow-md hover:bg-purple-600 transition duration-300"
              >
                Close
              </button>
