  ...
  return (
    <div className='bg-purple-200 min-h-screen'>
      ...
      <div className='flex items-center justify-center mt-10 p-4'>
        <form onSubmit={handleSubmit} method='post' className='bg-gradient-to-l from-pink-200 to-pink-700 rounded-lg shadow-lg p-10 max-w-lg w-full'>
          <fieldset>
            <legend className='text-white font-bold text-4xl text-center mb-8'>Contact Us</legend>

            {/* Name Input */}
            <label className='text-purple-800 font-bold mb-2 block'>Name:</label>
            <input
              type="text"
              name="name"
